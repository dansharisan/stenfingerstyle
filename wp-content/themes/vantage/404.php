		...
		<article id="post-0" class="post error404 not-found">
			...
			<div class="entry-main">
				...
				<div class="entry-content">
					<p><?php echo apply_filters( 'vantage_404_message', __( 'It looks like nothing was found at this location. Maybe you want to perform a search?', 'vantage' ) ); ?></p>

					<?php get_search_form(); ?>
                                        
                                        <!-- Modification: Not to display unnecessary information -->
